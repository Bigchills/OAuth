...
const Auth = () => {
    ...
    return (
        <>
            <div className="w-full flex h-screen mx-auto border-black">
                <div className='border-b border-slate-600 w-1/4 flex justify-center items-center bg-white h-screen'>
                    <h2 className="text-4xl text-blue-600 font-semibold mb-2">Roomieapp</h2>
                </div>
                <div className='flex-1 flex justify-center items-center shadow-inner'>
                    <div className="flex flex-col font-semibold px-5 space-y-5 min-w-80 mx-auto rounded-sm bg-white shadow py-10">
                        <button className='border rounded-xl py-3 px-2 hover:bg-black hover:text-white' onClick={redirect}>
                        ...
                        <button className='border rounded-xl py-3 px-2 hover:bg-black hover:text-white'>
                            <a className="flex items-center gap-1">
                                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="20" height="20" viewBox="0 0 48 48">
                        ...
                        <div className="rounded-full border min-w-10 min-h-10 mx-auto shadow p-1 flex justify-center items-center font-semibold">Or</div>
                        ...
                        <div className="flex justify-center items-center space-x-2 font-semibold">
                            ...
                            <button onClick={openLogin} className="text-blue-700 hover:text-blue-900">
                                Sign in
                            </button>
                        </div>
                    </div>
